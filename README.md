...
- **Retriever**: [ForwardAILabs/MRE-T1 on HuggingFace](https://huggingface.co/ForwardAILabs/MRE-T1) — Mira Recruitment Embedding, Thought v1
- **Query Rewriter**: [ForwardAILabs/MQR-A1 on HuggingFace](https://huggingface.co/ForwardAILabs/MQR-A1) — Mira Query Rewriter, Alignment v1
